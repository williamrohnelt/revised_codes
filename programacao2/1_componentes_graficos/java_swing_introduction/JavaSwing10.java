...
public class JavaSwing10 extends JFrame {
    ...
    public static JavaSwing10 minhaJanela;
    ...
    ActionListener acaoParaOBotao = new ActionListener(){
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if( arg0.getActionCommand().equals( "Apertar" ) ) {
                JOptionPane.showMessageDialog( minhaJanela, "Apertou o bot�o" );
            } 	
        }
    };
    
    public static void main(String[] args) {
        minhaJanela = new JavaSwing10();
